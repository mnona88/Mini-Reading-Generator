...
function getTheme(resultColor, selectedColor) {
  ...
  const map = {
    ...
    "Burnt Orange->Dark Blue": "Slow what races",
    "Burnt Orange->Ivory": "Stop forcing brightness",
...
- You have been making exhaustion look elegant.
- Rest is what your pride keeps delaying.
- You do not need more control.
- You are overdue for softness.
`.trim();
